...
public class MudLogNameFormationDaoImpl implements MudLogNameFormationDao {

    private BigQuery bigQuery;
    private TableId tableId;
    private final static String TABLE_NAME = "mudLogs_nameformation";

    public MudLogNameFormationDaoImpl() throws IOException {
        bigQuery = ConnectionFactory.getConnection();
        tableId = TableId.of(GlobalOptions.getInstance().getDataSetName(), MudLogNameFormationDaoImpl.TABLE_NAME);
    }
